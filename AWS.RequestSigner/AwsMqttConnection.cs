...
using AWS.RequestSigner.Signers;

namespace AWS.RequestSigner
{
  public class AwsMqttConnection
  {
    ...
    public string SignRequestUrl()
    {
      ...
      var aws4SignerForQueryParameterAuth = new AWS4SignerForQueryParameterAuth
      {
      ...
      var authorization = aws4SignerForQueryParameterAuth.ComputeSignature(headers,
        string.Empty,
